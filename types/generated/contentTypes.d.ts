...
export interface ApiCategoriaAppleCategoriaApple
  extends Struct.CollectionTypeSchema {
  collectionName: 'categoria_apples';
  info: {
    description: '';
    displayName: 'categoria-apple';
    pluralName: 'categoria-apples';
    singularName: 'categoria-apple';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::categoria-apple.categoria-apple'
    > &
      Schema.Attribute.Private;
...
export interface ApiDatosGlobalDatosGlobal extends Struct.CollectionTypeSchema {
  collectionName: 'datos_globals';
  info: {
    description: '';
    displayName: 'datosGlobal';
    pluralName: 'datos-globals';
    singularName: 'datos-global';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    linkBancoBogota: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::datos-global.datos-global'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiPaginaPagina extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    zona_dinamica: Schema.Attribute.DynamicZone<
      ['zona-dinamica.hero', 'zona-dinamica.novedades']
    >;
  };
}
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    categoria: Schema.Attribute.Enumeration<
      ['populares', 'novedades', 'ofertas', 'usados', 'accesorios']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcion: Schema.Attribute.Text & Schema.Attribute.Required;
    especificaciones: Schema.Attribute.DynamicZone<
      ['especificaciones.colores-del-dispositivo', 'especificaciones.capacidad']
    >;
    ...
    tipo: Schema.Attribute.Relation<'oneToOne', 'api::tipo.tipo'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::categoria-apple.categoria-apple': ApiCategoriaAppleCategoriaApple;
      'api::color.color': ApiColorColor;
      'api::datos-global.datos-global': ApiDatosGlobalDatosGlobal;
